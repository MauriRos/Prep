...
function elevarAlCuadrado(num) {
  ...
  // Tu código:
  var  NumAlCuadrado = Math.pow(num,2);
...
function elevar(num, exponent) {
  ...
  // Tu código:
  var eleNumAlexpont = Math.pow (num, exponent);
    return eleNumAlexpont
}
...
function retornarPerimetro(lado){
  ...
  // Tu código:
  var ladoperimetro = lado * 4;
  return ladoperimetro;
}
